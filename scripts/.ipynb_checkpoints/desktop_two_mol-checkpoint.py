...
for p in range(5):
    ...
    history = chemvae.autoencoder.fit([X_train_cat, X_train_ani], [X_train_cat, X_train_ani],
                                      shuffle = False)
    histories.append(history.history)
    name = 'gen3_2mol_1mil_GDB17_mix_pure'
    chemvae.save('../models/{}_{}.h5'.format(name,p+1))
